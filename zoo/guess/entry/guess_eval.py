...
from zoo.guess.config.guess_muzero_config import main_config, create_config
...
if __name__ == "__main__":
    ...
    model_path = "./ckpt/iteration_4000.pth.tar"
    ...
    main_config.env.max_episode_steps = int(1e3)  # Adjust according to different environments
